...
There are methods for picking initial weights, so that problems with local maximums of derivatives are not limiting the backpropagation algorithm.
%\cite{http://ce.sharif.edu/courses/84-85/2/ce667/resources/root/Seminar_no_6/Widrow.pdf}%
